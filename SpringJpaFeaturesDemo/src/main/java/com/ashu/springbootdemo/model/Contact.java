...
@NamedNativeQueries({
		...
		/*
		 * Spring Data JPA doesn’t support dynamic sorting for native queries. Doing
		 * that would require Spring Data to analyze the provided statement and generate
		 * the ORDER BY clause in the database-specific dialect. This would be a very
		 * complex operation and is currently not supported by Spring Data JPA.
		 */
